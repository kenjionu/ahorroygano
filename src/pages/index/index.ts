...
*/
  presentProfileModal(value:any) {
    let profileModal = this.modalCtrl.create('BusquedaresultadoPage', ({ category: this.Filtroform.value.category, type: this.Filtroform.value.type, city: this.Filtroform.value.city, provincie: this.Filtroform.value.provincie }));
